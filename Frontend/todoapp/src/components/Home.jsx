...
const Home = () => {
    ...
    useEffect(() => {
        ...
        checkToken();
    }, []); // ← fix: hanya jalankan saat mount pertama

    return (
        <div className='h-screen'>
            <div className='flex flex-col items-center justify-center h-full w-full'>
                <div
                    style={{ backgroundColor: "rgba(247, 237, 225, 0.6)", width: "50%" }}
                ...
                >
                    ...
                    <p className='text-lg'>
                        TodoTask membantumu mengelola daftar tugas harian dengan mudah dan efisien. Fokus pada hal penting tanpa kehilangan arah.
                    </p>
                    ...
                    {isLoggedIn ? (
                        <Link to="/addtask" className="mx-auto no-underline text-white">
                            <button
                                ...
                                className='mt-4 mx-auto flex gap-2 items-center text-center font-bold text-lg hover:bg-[#6b4726] transition-all duration-300 ease-in-out transform hover:scale-105 shadow-md hover:shadow-lg'
                            >
